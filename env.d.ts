/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 295e82cd4926372c234887a21e1a82c5)
// Runtime types generated with workerd@1.20260918.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	IncidentCommander: DurableObjectNamespace<import("./src/server").IncidentCommander>;
	INVESTIGATION_WORKFLOW: Workflow<Parameters<import("./src/server").InvestigationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "IncidentCommander";
	}
